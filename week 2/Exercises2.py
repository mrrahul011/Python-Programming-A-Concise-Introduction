...
#%%
def average(numlis):
    s=0#sum initially zero
    for i in numlis:
        print(i)
        s=s+i
    print("Sum of the list: ",s)    
    print("Length of the list is: ",len(numlis))
    A=s/(len(numlis))
    print("Average : ",A)
#%%
"""
...
def population(state_data):
    ...
    for i in range(0,num_states):
        #print(state_data[i][1]),this can be used directly insted of pop
...
def menu():
    order=[]
    print("   Enter the menu item, type\"'that's all'\" to stop odering   ")
